  ...
  <ul id="menu">
    ...
    <li class="User">
		...
		<c:if test="${ ! empty member }">
			...
			<ul>
        		<li>
          			<a href="memberinformation.jsp" id="a2">會員資料</a>
      ...
      <div>
        <p class="bodyleftinsidep">想找什麼團呢?</p>
          <div class="bodyleftlimbo"><p>
            ...
            <p id="selectonep">遊戲時間</p>
            <select id="selectone" class="gray">
              <option>1小時</option>
              <option>2小時</option>
              <option>3小時</option>
              <option>4小時</option>
            ...
            <p id="selectthreep">遊戲開始時間</p>
            <input type="text" id="textthree" placeholder="yyyy/mm/dd">
            <p id="selectfourp">遊戲結束時間</p>
            <input type="text" id="textfour" placeholder="yyyy/mm/dd">
